...
author: "Lili Benitez, Livia Raulinaitis, Ariel Chasen"
date: "2026-01-16"
...
d <- read_excel("WC_AccessibilityPilot_anaon.xlsx") 
...
## Supplement
```{r, echo=FALSE}
wilcox.test(d$Mean_SPIRES_post, d$Mean_SPIRES_pre, paired=TRUE) #warnings about exact p value with ties and zeros

wilcox.test(d$PIO_post,d$PIO_pre, paired=TRUE) #warnings about ties and zeros. V = 653.5, p-value = 5.374e-06
