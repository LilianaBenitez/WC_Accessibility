...
m_spires<-lmer(SPIRES_delta~gender2+LGBT+D_phy+D_Men+D_Sen+D_Learn+D_Chron+Race_W+(1|Session), data=d5)
summary(m_spires)
check_overdispersion(m_spires)

m_pio<-lmer(PIO_delta~gender2+LGBT+D_phy+D_Men+D_Sen+D_Learn+D_Chron+Race_W+(1|Session), data=d5)
summary(m_pio)
check_overdispersion(m_spires)

m_bel<-lmer(BEL_delta~gender2+LGBT+D_phy+D_Men+D_Sen+D_Learn+D_Chron+Race_W+(1|Session), data=d5)
summary(m_bel)
...
t.test(d_LGBT_learn$Mean_SPIRES_post,d_LGBT_learn$Mean_SPIRES_pre)
